...
#' @title (4-way) coupled multinomial resampling by maximally coupling across levels and maximally coupling
#' chains with independent residuals 
#' @description This function performs (4-way) coupled multinomial resampling by maximally coupling across levels and 
#' maximally coupling chains with independent residuals on each particle system
#' @param normweights1 normalized weights of first particle system
#' @param normweights2 normalized weights of second particle system
#' @param normweights3 normalized weights of third particle system
#' @param normweights4 normalized weights of fourth particle system
...
#' @return A matrix of ancestor indexes of size ndraws x 4
#' @export
coupled4_maximallevels_maximalchains_independent_residuals <- function(normweights1, normweights2, normweights3, normweights4, ndraws, rand){
  
  output <- maximal_maximal_multinomial_resampling(normweights1, normweights2, 
                                                   normweights3, normweights4, 
...
#' @title (4-way) coupled multinomial resampling by maximally coupling across levels and maximally coupling
#' chains with coupled residuals using common uniform random variables 
#' @description This function performs (4-way) coupled multinomial resampling by maximally coupling across levels and 
#' maximally coupling chains with coupled residuals using common uniform random variables on each particle system
#' @param normweights1 normalized weights of first particle system
#' @param normweights2 normalized weights of second particle system
#' @param normweights3 normalized weights of third particle system
#' @param normweights4 normalized weights of fourth particle system
...
#' @return A matrix of ancestor indexes of size ndraws x 4
#' @export
coupled4_maximallevels_maximalchains_coupled_residuals <- function(normweights1, normweights2, normweights3, normweights4, ndraws, rand){
...
#' @title (4-way) coupled multinomial resampling by maximally coupling chains and maximally coupling
#' across levels with independent residuals 
#' @description This function performs (4-way) coupled multinomial resampling by maximally coupling chains and 
#' maximally coupling across levels with independent residuals on each particle system
#' @param normweights1 normalized weights of first particle system
#' @param normweights2 normalized weights of second particle system
#' @param normweights3 normalized weights of third particle system
#' @param normweights4 normalized weights of fourth particle system
...
#' @return A matrix of ancestor indexes of size ndraws x 4
#' @export
coupled4_maximalchains_maximallevels_independent_residuals <- function(normweights1, normweights2, normweights3, normweights4, ndraws, rand){
  
  output <- maximal_maximal_multinomial_resampling(normweights1, normweights3, 
                                                   normweights2, normweights4, 
                                                   ndraws, residualtype = 1)
...
#' @title (4-way) coupled multinomial resampling by maximally coupling chains and maximally coupling
#' across levels with coupled residuals using common uniform random variables 
#' @description This function performs (4-way) coupled multinomial resampling by maximally coupling chains and 
#' maximally coupling across levels with coupled residuals using common uniform random variables on each particle system
#' @param normweights1 normalized weights of first particle system
#' @param normweights2 normalized weights of second particle system
#' @param normweights3 normalized weights of third particle system
#' @param normweights4 normalized weights of fourth particle system
...
#' @return A matrix of ancestor indexes of size ndraws x 4
#' @export
coupled4_maximalchains_maximallevels_coupled_residuals <- function(normweights1, normweights2, normweights3, normweights4, ndraws, rand){
